import { Menu, Search, Globe, Tickets } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            ...
            <Button variant="ghost" size="icon" className="ml-2" aria-label="Trip Tickets"
              onClick={() => { router.push("/trips") }}
            >
              <Tickets className="h-9 w-9" />
            </Button>
            ...
            <Button variant="outline" size="icon" className="ml-2 w-20 border-gray-300">
              ...
              <div className='h-5 w-5 ml-2 flex justify-center items-center'>
                <UserButton />
              </div>
            </Button>
          </div>
